...
class HashFunction2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(theFunc.isPrime(61));
...
//    }
    ...
    public void doubleHashFunc(String[] stringsForArray, String[] theArray) {
        ...
        for (int n = 0; n < stringsForArray.length; n++) {
            ...
            System.out.println("Element to fill: " + newElementVal);
...
//            System.out.println("step distance: " + stepDistance);
            ...
            while (!theArray[arrayIndex].equals("-1")) {
                ...
                System.out.println("Collision occured at index: " + arrayIndex);
                arrayIndex += stepDistance;
                System.out.println("Try index: " + arrayIndex + " instead");
            ...
            System.out.println("New element inserted at index: " + arrayIndex);
